...
| 2026-08-29 | Launch | [Private Alpha Scope Boundary](./aipde/2026-08-29-private-alpha-scope-boundary.md) | Local Alpha boundary is machine-validated and browser-accepted; publication remains pending | Private Alpha checkpoint after `a577fe0c3d7810a061a3218a02b2cc9d749f1607` |
| 2026-09-03 | Operations | [Local Release Rollback Proof](./operations/2026-09-03-local-release-rollback-proof.md) | Local rollback simulation passed; staging and production execution remain blocked | working tree after `91c616a` |
