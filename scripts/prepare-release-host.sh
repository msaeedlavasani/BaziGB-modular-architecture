...
Cmnd_Alias BAZIGB_RELEASE = /usr/local/sbin/bazigb-release prepare *, /usr/local/sbin/bazigb-release verify *, /usr/local/sbin/bazigb-release canary *, /usr/local/sbin/bazigb-release preflight *, /usr/local/sbin/bazigb-release diagnose *, /usr/local/sbin/bazigb-release activate *
